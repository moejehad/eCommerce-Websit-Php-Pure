...
<header class="yelsto">
               ...
               <div class="logo pull-right"><a href="index.php"><img src="./layout/imgs/Y-Logo.png" /></a></div>
                ...
                <?php 
                    ...
                    if(isset($_SESSION['user'])){ 
                     ...
                     echo '<div class="prf pull-left"><a href="profile.php?user='. $sessionUser .'"><span class=" btn btn-primary"><i class="fa fa-user"></i> ' . $sessionUser . '</span></a></div>';
                        
                     echo "<div class='prf notification pull-left'><a href='notifications.php?user=" . $sessionUser . " '>
                     <i class='fa fa-bell-o'></i><span class='counter pull-left'> " . countNotify('notID', 'notifications' , 'notiName', $sessionUser) . "</span></a></div>";
                        
                    echo "<div class='prf notification pull-left'><a href='inbox.php?user=" . $sessionUser . " '>
                     <i class='fa fa-envelope'></i><span class='counter pull-left'> " . countMsgRd('msgID', 'msg' , 'received' , $sessionUser ) . "</span></a></div>";
                        
                       
                    }else{
               
                        echo '<div class="login pull-left"><a href="login.php">
    ...
    <div class="main-header">
        ...
        <div class="info pull-right">
            <h2 class="title"> Yellow Store  </h2>
            <p class="desc">منصة تجارة إلكترونية الأولى من نوعها في فلسطين <br> جميع ما تحتاجه أصبح متاحاً في مكان واحد </p>
            <a href="register.php" class="btn btn-info"><i class="fa fa-user-plus"></i> انضم الآن</a>
        </div>
        <div class="img pull-left"><img src="./layout/imgs/Untitled-1.png" /> </div>
    </div>
    </div>
</header> 